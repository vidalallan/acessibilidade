...
<body>
    ...
    <section>
        <div class="container-fluid" style="max-width: 60%;margin: 0 auto;">

            <div>
                <h1> Cadastro dos Problemas de Acessibilidade </h1>
            </div>
            ...
            <form>
                ...
                <div class="mb-3">
                    <label for="" class="form-label">ID do Dispositivo</label>
                    <input type="text" class="form-control" id="" aria-describedby="">
                    <div id="" class="form-text">Descrição para preenchimento do campo.</div>
                </div>
